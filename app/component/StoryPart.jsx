    ...
    <div className='pt-[120px] '>
        <Container>
            <div className='relative pb-[60px]'>
                <div className='bg-[#F7E7E8] p-[60px] w-[1096px] rounded-[20px] relative'>
                    <h3 className='font-cinzel font-bold text-[48px] text-[#0C0C0C] uppercase'>our story</h3>
                    
                    <p className='w-[664px] text-[#0C0C0C] font-raleway text-[16px] mt-5'>At Sum Dim Sum, we are a local Singaporean brand that prepares dim sum dishes with wholehearted dedication and passion. Our chefs use traditional techniques to craft our dishes, ensuring that they are of the highest quality. Come and experience our fresh and flavorful cuisine.</p>
                    <button className='bg-[#B31217] text-white text-[16px] font-semibold py-3 px-5 rounded-[10px] mt-[40px] flex items-center font-raleway cursor-pointer'>Learn More
